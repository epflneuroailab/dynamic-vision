...
VIDEO_DIR = '/home/ytang/workspace/data/ssv2/'
...
def load_dataset(identifier="smthsmthv2"):
...
def get_data():
    ...
    out_dir = os.path.join(VIDEO_DIR, 'brainscore')
    ...
    for i, action_type in enumerate(os.listdir(video_dir)):
        ...
        for j, video_name in enumerate(os.listdir(action_dir)):
            ...
            store_path = os.path.join(out_dir, action_type, video_name.replace('.webm', '.mp4'))
